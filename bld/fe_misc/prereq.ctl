# FE_MISC Prequisite Tool Build Control File
# ==========================================
...
#==================
    ...
    rm -f <OWBINDIR>/genverrc
    rm -f <OWBINDIR>/genverrc.exe
    set BUILD_PLATFORM=
...
#================================
    ...
    <CPCMD> genverrc.exe <OWBINDIR>/genverrc.exe
...
#==================================
    ...
    <CPCMD> genverrc.exe <OWBINDIR>/genverrc
