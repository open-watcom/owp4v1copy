...
pick( TOK_PROC_BASIC,    "BASIC",        LANG_BASIC,     0               ),
pick( TOK_PROC_FORTRAN,  "FORTRAN",      LANG_FORTRAN,   0               ),
pick( TOK_PROC_PASCAL,   "PASCAL",       LANG_PASCAL,    0               ),
pick( TOK_PROC_C,        "C",            LANG_C,         0               ),
pick( TOK_PROC_WATCOM_C, "WATCOM_C",     LANG_WATCOM_C,  0               ),
pick( TOK_PROC_STDCALL,  "STDCALL",      LANG_STDCALL,   0               ),
pick( TOK_PROC_SYSCALL,  "SYSCALL",      LANG_SYSCALL,   0               ),
