/*
    Include file for Windows 3.x Multimedia APIs. Requires windows.h.
*/
...
LRESULT   WINAPI DrvClose(HDRVR,LPARAM,LPARAM);
HDRVR     WINAPI DrvOpen(LPCSTR,LPCSTR,LPARAM);
LRESULT   WINAPI DrvSendMessage(HDRVR,UINT,LPARAM,LPARAM);
HINSTANCE WINAPI DrvGetModuleHandle(HDRVR);
LRESULT   WINAPI DrvDefDriverProc(DWORD,HDRVR,UINT,LPARAM,LPARAM);
