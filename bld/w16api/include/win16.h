...
typedef struct tagCBT_CREATEWND {
    ...
    HWND hwndInsertAfter;
} CBT_CREATEWND, FAR *LPCBT_CREATEWND;
...
typedef struct tagEVENTMSG {
    ...
    UINT  paramH;
    DWORD time;
} EVENTMSG, *PEVENTMSG, NEAR *NPEVENTMSG, FAR *LPEVENTMSG;
...
typedef struct tagDEBUGHOOKINFO {
    ...
    WPARAM  wParam;
    int     code;
} DEBUGHOOKINFO, FAR *LPDEBUGHOOKINFO;
...
typedef struct {
    ...
    int  wMax;
    char rgchMember[2];
} HELPWININFO, NEAR *PHELPWININFO, FAR *LPHELPWININFO;
...
} DRVCONFIGINFO, NEAR *PDRVCONFIGINFO, FAR *LPDRVCONFIGINFO;
...
} DRIVERINFOSTRUCT, FAR *LPDRIVERINFOSTRUCT;
