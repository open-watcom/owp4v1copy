...
#========================
  ...
  [ IFDEF (os_nt "") <2*> ]
    ...
    <CPCMD> <DEVDIR>/viper/viper/nt/pbide.cfg       <RELROOT>/binnt/pbide.cfg
    <CPCMD> <DEVDIR>/viper/viper/idepbnt.cfg        <RELROOT>/binnt/idepbnt.cfg
    <CPCMD> <DEVDIR>/viper/viper/nt/pbidex.cfg      <RELROOT>/binnt/pbidex.cfg
  [ ENDIF ]
    ...
    <CPCMD> <DEVDIR>/viper/viper/win/pbide.cfg      <RELROOT>/binw/pbide.cfg
    <CPCMD> <DEVDIR>/viper/viper/idepb.cfg          <RELROOT>/binw/idepb.cfg
    <CPCMD> <DEVDIR>/viper/viper/win/pbidex.cfg     <RELROOT>/binw/pbidex.cfg
