...
ins_table MIPSTable[] = {
 ...
 // Memory Branch Instructions
    INS( "jmp",     0x1A,   0x00,   IT_MEMORY_JUMP,         ENUM_NONE ),
    INS( "jsr",     0x1A,   0x01,   IT_MEMORY_JUMP,         ENUM_NONE ),
 ...
 // Operate Format Instructions
    ...
    INS( "addu",    0x10,   0x20,   IT_OPERATE,             ENUM_OF_ADDL ),
    ...
    INS( "cmple",   0x10,   0x6D,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmplt",   0x10,   0x4D,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmpule",  0x10,   0x3D,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmpult",  0x10,   0x1D,   IT_OPERATE,             ENUM_NONE ),
    INS( "subl",    0x10,   0x09,   IT_OPERATE,             ENUM_OF_ADDL ),
    INS( "subq",    0x10,   0x29,   IT_OPERATE,             ENUM_OF_ADDL ),
    INS( "s4addl",  0x10,   0x02,   IT_OPERATE,             ENUM_NONE ),
    INS( "s4addq",  0x10,   0x22,   IT_OPERATE,             ENUM_NONE ),
    INS( "s4subl",  0x10,   0x0B,   IT_OPERATE,             ENUM_NONE ),
    INS( "s4subq",  0x10,   0x2B,   IT_OPERATE,             ENUM_NONE ),
    INS( "s8addl",  0x10,   0x12,   IT_OPERATE,             ENUM_NONE ),
    INS( "s8addq",  0x10,   0x32,   IT_OPERATE,             ENUM_NONE ),
    INS( "s8subl",  0x10,   0x1B,   IT_OPERATE,             ENUM_NONE ),
    INS( "s8subq",  0x10,   0x3B,   IT_OPERATE,             ENUM_NONE ),
    INS( "and",     0x11,   0x00,   IT_OPERATE,             ENUM_NONE ),
    INS( "bic",     0x11,   0x08,   IT_OPERATE,             ENUM_NONE ),
    INS( "bis",     0x11,   0x20,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmoveq",  0x11,   0x24,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmovlbc", 0x11,   0x16,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmovlbs", 0x11,   0x14,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmovge",  0x11,   0x46,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmovgt",  0x11,   0x66,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmovle",  0x11,   0x64,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmovlt",  0x11,   0x44,   IT_OPERATE,             ENUM_NONE ),
    INS( "cmovne",  0x11,   0x26,   IT_OPERATE,             ENUM_NONE ),
    INS( "eqv",     0x11,   0x48,   IT_OPERATE,             ENUM_NONE ),
    INS( "ornot",   0x11,   0x28,   IT_OPERATE,             ENUM_NONE ),
    INS( "xor",     0x11,   0x40,   IT_OPERATE,             ENUM_NONE ),
    INS( "extbl",   0x12,   0x06,   IT_OPERATE,             ENUM_NONE ),
    INS( "extlh",   0x12,   0x6A,   IT_OPERATE,             ENUM_NONE ),
    INS( "extll",   0x12,   0x26,   IT_OPERATE,             ENUM_NONE ),
    INS( "extqh",   0x12,   0x7A,   IT_OPERATE,             ENUM_NONE ),
    INS( "extql",   0x12,   0x36,   IT_OPERATE,             ENUM_NONE ),
    INS( "extwh",   0x12,   0x5A,   IT_OPERATE,             ENUM_NONE ),
    INS( "extwl",   0x12,   0x16,   IT_OPERATE,             ENUM_NONE ),
    INS( "insbl",   0x12,   0x0B,   IT_OPERATE,             ENUM_NONE ),
    INS( "inslh",   0x12,   0x67,   IT_OPERATE,             ENUM_NONE ),
    INS( "insll",   0x12,   0x2B,   IT_OPERATE,             ENUM_NONE ),
    INS( "insqh",   0x12,   0x77,   IT_OPERATE,             ENUM_NONE ),
    INS( "insql",   0x12,   0x3B,   IT_OPERATE,             ENUM_NONE ),
    INS( "inswh",   0x12,   0x57,   IT_OPERATE,             ENUM_NONE ),
    INS( "inswl",   0x12,   0x1B,   IT_OPERATE,             ENUM_NONE ),
    INS( "mskbl",   0x12,   0x02,   IT_OPERATE,             ENUM_NONE ),
    INS( "msklh",   0x12,   0x62,   IT_OPERATE,             ENUM_NONE ),
    INS( "mskll",   0x12,   0x22,   IT_OPERATE,             ENUM_NONE ),
    INS( "mskqh",   0x12,   0x72,   IT_OPERATE,             ENUM_NONE ),
    INS( "mskql",   0x12,   0x32,   IT_OPERATE,             ENUM_NONE ),
    INS( "mskwh",   0x12,   0x52,   IT_OPERATE,             ENUM_NONE ),
    INS( "mskwl",   0x12,   0x12,   IT_OPERATE,             ENUM_NONE ),
    INS( "sll",     0x12,   0x39,   IT_OPERATE,             ENUM_NONE ),
    INS( "sra",     0x12,   0x3C,   IT_OPERATE,             ENUM_NONE ),
    INS( "srl",     0x12,   0x34,   IT_OPERATE,             ENUM_NONE ),
    INS( "zap",     0x12,   0x30,   IT_OPERATE,             ENUM_NONE ),
    INS( "zapnot",  0x12,   0x31,   IT_OPERATE,             ENUM_NONE ),
 ...
 // Floating-Point Operate Format Instructions - IEEE
    ...
    INS( "mult",    0x16,   0xA2,   IT_FP_OPERATE,          ENUM_IEEE_ADDS ),
 ...
 // Stylized Code Forms
    ...
    INS( "or",      0x11,   0x20,   IT_OPERATE,             ENUM_NONE ),
