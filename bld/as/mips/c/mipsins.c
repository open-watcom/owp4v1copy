...
ins_table MIPSTable[] = {
 ...
 // Memory Format Instructions
    ...
    INS( "swr",     0x2d,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
  // Unaligned memory format pseudo-instructions
    ...
    INS( "ldah",    0x09,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "ldf",     0x20,   0x00,   IT_FP_MEMORY_ALL,   ENUM_NONE,  MIPS_ISA1 ),
    INS( "ldg",     0x21,   0x00,   IT_FP_MEMORY_ALL,   ENUM_NONE,  MIPS_ISA1 ),
    INS( "ldl",     0x28,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "ldl_l",   0x2A,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "ldq",     0x29,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "ldq_l",   0x2B,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "ldq_u",   0x0B,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "lds",     0x22,   0x00,   IT_FP_MEMORY_ALL,   ENUM_NONE,  MIPS_ISA1 ),
    INS( "ldt",     0x23,   0x00,   IT_FP_MEMORY_ALL,   ENUM_NONE,  MIPS_ISA1 ),
    INS( "stf",     0x24,   0x00,   IT_FP_MEMORY_ALL,   ENUM_NONE,  MIPS_ISA1 ),
    INS( "stg",     0x25,   0x00,   IT_FP_MEMORY_ALL,   ENUM_NONE,  MIPS_ISA1 ),
    INS( "stl",     0x2C,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "stl_c",   0x2E,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "stq",     0x2D,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "stq_c",   0x2F,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "stq_u",   0x0F,   0x00,   IT_MEMORY_ALL,      ENUM_NONE,  MIPS_ISA1 ),
    INS( "sts",     0x26,   0x00,   IT_FP_MEMORY_ALL,   ENUM_NONE,  MIPS_ISA1 ),
    INS( "stt",     0x27,   0x00,   IT_FP_MEMORY_ALL,   ENUM_NONE,  MIPS_ISA1 ),
 ...
 // Branch Format Instructions
    ...
    INS( "fblt",    0x32,   0x00,   IT_FP_BRANCH,       ENUM_NONE,  MIPS_ISA1 ),
    INS( "fble",    0x33,   0x00,   IT_FP_BRANCH,       ENUM_NONE,  MIPS_ISA1 ),
    INS( "bsr",     0x34,   0x00,   IT_BRANCH,          ENUM_NONE,  MIPS_ISA1 ),
    INS( "fbne",    0x35,   0x00,   IT_FP_BRANCH,       ENUM_NONE,  MIPS_ISA1 ),
    INS( "fbge",    0x36,   0x00,   IT_FP_BRANCH,       ENUM_NONE,  MIPS_ISA1 ),
    INS( "fbgt",    0x37,   0x00,   IT_FP_BRANCH,       ENUM_NONE,  MIPS_ISA1 ),
    INS( "blbc",    0x38,   0x00,   IT_BRANCH,          ENUM_NONE,  MIPS_ISA1 ),
    INS( "blt",     0x3A,   0x00,   IT_BRANCH,          ENUM_NONE,  MIPS_ISA1 ),
    INS( "ble",     0x3B,   0x00,   IT_BRANCH,          ENUM_NONE,  MIPS_ISA1 ),
    INS( "blbs",    0x3C,   0x00,   IT_BRANCH,          ENUM_NONE,  MIPS_ISA1 ),
 ...
 // Operate Format Instructions
    ...
    INS( "sll",     0x00,   0x00,   IT_OPERATE_IMM,     ENUM_NONE,  MIPS_ISA1 ),
    INS( "srl",     0x00,   0x02,   IT_OPERATE_IMM,     ENUM_NONE,  MIPS_ISA1 ),
    ...
    INS( "cmpbge",  0x10,   0x0F,   IT_OPERATE,         ENUM_NONE,  MIPS_ISA1 ),
    INS( "cmpeq",   0x10,   0x2D,   IT_OPERATE,         ENUM_NONE,  MIPS_ISA1 ),
    INS( "bic",     0x11,   0x08,   IT_OPERATE,         ENUM_NONE,  MIPS_ISA1 ),
    INS( "bis",     0x11,   0x20,   IT_OPERATE,         ENUM_NONE,  MIPS_ISA1 ),
    INS( "umulh",   0x13,   0x30,   IT_OPERATE,         ENUM_NONE,  MIPS_ISA1 ),
 ...
 // Moves to/from special registers
    INS( "mfhi",    0x00,   0x10,   IT_MOV_SPECIAL,     ENUM_NONE,  MIPS_ISA1 ),
    INS( "mthi",    0x00,   0x11,   IT_MOV_SPECIAL,     ENUM_NONE,  MIPS_ISA1 ),
    INS( "mflo",    0x00,   0x12,   IT_MOV_SPECIAL,     ENUM_NONE,  MIPS_ISA1 ),
    INS( "mtlo",    0x00,   0x13,   IT_MOV_SPECIAL,     ENUM_NONE,  MIPS_ISA1 ),
 // Moves to/from FPU
 ...
 // Stylized Code Forms
    ...
    INS( "fnegf",   0x17,   0x21,   IT_PSEUDO_FNEG,     ENUM_NONE,  MIPS_ISA1 ),
    INS( "fnegg",   0x17,   0x21,   IT_PSEUDO_FNEG,     ENUM_NONE,  MIPS_ISA1 ),
    INS( "fnegs",   0x17,   0x21,   IT_PSEUDO_FNEG,     ENUM_NONE,  MIPS_ISA1 ),
    INS( "fnegt",   0x17,   0x21,   IT_PSEUDO_FNEG,     ENUM_NONE,  MIPS_ISA1 ),
    INS( "not",     0x11,   0x28,   IT_PSEUDO_NOT,      ENUM_NONE,  MIPS_ISA1 ),
