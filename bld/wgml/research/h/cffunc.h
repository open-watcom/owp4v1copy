...
code_block      *   get_code_blocks( uint8_t * * position, uint16_t count, uint8_t * base, char * block );
p_buffer        *   get_p_buffer( FILE * file );
functions_block *   parse_functions_block( uint8_t * * position, uint8_t * base, char * block );
