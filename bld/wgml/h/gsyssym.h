...
//      name     symbol
  ...
  picl( cd,      chars,   no_free+ro+access_fun+predefined          )
  ...
  picc( cw,      date,    no_free+ro+predefined+late_subst          )
  ...
  pick( parm,    passno,  no_free+ro+access_fun+predefined          )
  ...
  picl( pgnuma,  pgnumc,  no_free+ro+access_fun+predefined          )
  picl( pgnumc,  pgnumr,  no_free+ro+access_fun+predefined          )
  picl( pgnumr,  pi,      no_free+ro+access_fun+predefined          )
  ...
  picc( screen,  sec,     no_free+ro+access_fun+predefined          )
  pick( sec,     second,  no_free+ro+access_fun+predefined          )
  ...
  picl( spcond,  stitle,  no_free+ro+access_fun+predefined          )
  pick( stitle,  su,      no_free+ro+access_fun+predefined          )
  ...
  picc( tiset,   title,   no_free+ro+access_fun+predefined          )
  pick( title,   tm,      no_free+ro+access_fun+predefined          )
