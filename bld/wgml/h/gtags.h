...
//                length
  ...
  pickg( ABSTRACT, 8,      gml_abstract,   0 )

  pickg( ADDRESS,  7,      gml_address,    0 )
  pickg( EADDRESS, 8,      gml_eaddress,   0 )
  ...
  pickg( DL,       2,      gml_dl,         tag_out_txt )
  pickg( EDL,      3,      gml_edl,        tag_out_txt )
  ...
  pickg( FRONTM,   6,      gml_frontm,     0           )
  pickg( GDOC,     4,      gml_gdoc,       0           )
  pickg( EGDOC,    5,      gml_egdoc,      tag_out_txt )

  pickg( GL,       2,      gml_gl,         tag_out_txt )
  ...
  pickg( LI,       2,      gml_li,         tag_out_txt )
  pickg( LIREF,    5,      gml_dummy,      tag_out_txt )
  pickg( LP,       2,      gml_lp,         tag_out_txt )
  ...
  pickg( OL,       2,      gml_ol,         tag_out_txt )
  pickg( EOL,      3,      gml_eol,        tag_out_txt )
  ...
  pickg( SL,       2,      gml_sl,         tag_out_txt )
  pickg( ESL,      3,      gml_esl,        tag_out_txt )

  pickg( TITLE,    5,      gml_title,      tag_out_txt )

  pickg( TITLEP,   6,      gml_titlep,     0 )
  pickg( ETITLEP,  7,      gml_etitlep,    tag_out_txt )

  pickg( TOC,      3,      gml_toc,        tag_out_txt )

  pickg( UL,       2,      gml_ul,         tag_out_txt )
  pickg( EUL,      3,      gml_eul,        tag_out_txt )
