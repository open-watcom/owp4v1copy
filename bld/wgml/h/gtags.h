...
//                  length
  ...
  pick( "ABSTRACT", 8,      gml_abstract,   tag_out_txt )
  pick( "ADDRESS",  7,      gml_address,    tag_out_txt )
  pick( "ALINE",    5,      gml_aline,      tag_out_txt )
  pick( "APPENDIX", 8,      gml_appendix,   tag_out_txt )
  pick( "AUTHOR",   6,      gml_author,     tag_out_txt )
  pick( "BACKM",    5,      gml_backm,      tag_out_txt )
  pick( "BINCLUDE", 8,      gml_dummy,      0 )
  pick( "BODY",     4,      gml_body,       tag_out_txt )
  pick( "CIT",      3,      gml_dummy,      tag_out_txt )
  pick( "CMT",      3,      gml_cmt,        tag_only )
  pick( "DATE",     4,      gml_date,       tag_out_txt )
  pick( "DD",       2,      gml_dummy,      tag_out_txt )
  pick( "DDHD",     4,      gml_dummy,      tag_out_txt )
  pick( "DL",       2,      gml_dummy,      tag_out_txt )
  pick( "DOCNUM",   6,      gml_docnum,     tag_out_txt )
  pick( "DT",       2,      gml_dummy,      tag_out_txt )
  pick( "DTHD",     4,      gml_dummy,      tag_out_txt )
  pick( "EADDRESS", 8,      gml_eaddress,   tag_out_txt )
  ...
  pick( "ETITLEP",  7,      gml_etitlep,    tag_out_txt )
  ...
  pick( "FRONTM",   6,      gml_frontm,     tag_out_txt )
  pick( "GDOC",     4,      gml_gdoc,       tag_out_txt )
  ...
  pick( "INDEX",    5,      gml_index,      tag_out_txt )
