...
//     word    name
  ...
  pick( "bf", scr_dummy, cw_o_t             )// begn font
...
//pick( "cm", scr_dummy, 0                  )// comment ----- handled differently
  ...
  pick( "ct", scr_dummy, cw_o_t             )// continued text
...
//pick( "fi", scr_dummy, 0                  )// old
  ...
  pick( "in", scr_dummy, cw_break+cw_o_t    )// indent
  ...
  pick( "oc", scr_dummy, cw_o_t             )// output comment
  ...
  pick( "pa", scr_dummy, cw_break+cw_o_t    )// page eject
  ...
  pick( "tb", scr_dummy, cw_break+cw_o_t    )// define tab stops
