...
inspick( repe_pr,       "repe",         0x000020f3,     0x000020ff,     X86PrefixRepe )
...
inspick( cmpss,         "cmpss",        0x00c20ff3,     0x00ffffff,     X86XMMRegModRM64_BImm)
...
inspick( divps,         "divps",        0x00005e0f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( divss,         "divss",        0x005e0ff3,     0x00ffffff,     X86XMMRegModRM64_B)
inspick( ldmxcsr,       "ldmxcsr",      0x0010ae0f,     0x0038ffff,     X86ModRM_24)
inspick( maxps,         "maxps",        0x00005f0f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( maxss,         "maxss",        0x005f0ff3,     0x00ffffff,     X86XMMRegModRM64_B)
inspick( minps,         "minps",        0x00005d0f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( minss,         "minss",        0x005d0ff3,     0x00ffffff,     X86XMMRegModRM64_B)
inspick( movaps,        "movaps",       0x0000280f,     0x0000feff,     X86XMMRegModRM64)
inspick( movhlps,       "movhlps",      0x00c0120f,     0x00c0ffff,     X86XMMRegModRM64_B)
...
inspick( movlhps,       "movlhps",      0x00c0160f,     0x00c0ffff,     X86XMMRegModRM64_B)
...
inspick( movss,         "movss",        0x00100ff3,     0x00feffff,     X86XMMRegModRM64)
inspick( movups,        "movups",       0x0000100f,     0x0000feff,     X86XMMRegModRM64)
inspick( mulps,         "mulps",        0x0000590f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( mulss,         "mulss",        0x00590ff3,     0x00ffffff,     X86XMMRegModRM64_B)
inspick( orps,          "orps",         0x0000560f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( rcpps,         "rcpps",        0x0000530f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( rcpss,         "rcpss",        0x00530ff3,     0x00ffffff,     X86XMMRegModRM64_B)
inspick( rsqrtps,       "rsqrtps",      0x0000520f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( rsqrtss,       "rsqrtss",      0x00520ff3,     0x00ffffff,     X86XMMRegModRM64_B)
inspick( shufps,        "shufps",       0x0000c60f,     0x0000ffff,     X86XMMRegModRM64_BImm)
inspick( sqrtps,        "sqrtps",       0x0000510f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( sqrtss,        "sqrtss",       0x00510ff3,     0x00ffffff,     X86XMMRegModRM64_B)
inspick( stmxcsr,       "stmxcsr",      0x0018ae0f,     0x0038ffff,     X86ModRM_24)
inspick( subps,         "subps",        0x00005c0f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( subss,         "subss",        0x005c0ff3,     0x00ffffff,     X86XMMRegModRM64_B)
inspick( ucomiss,       "ucomiss",      0x00002e0f,     0x0000ffff,     X86XMMRegModRM64_B)
...
inspick( pavgb,         "pavgb",        0x0000e00f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( pavgw,         "pavgw",        0x0000e30f,     0x0000ffff,     X86XMMRegModRM64_B)
...
inspick( pmaxsw,        "pmaxsw",       0x0000ee0f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( pmaxub,        "pmaxub",       0x0000de0f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( pminsw,        "pminsw",       0x0000ea0f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( pminub,        "pminub",       0x0000da0f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( pmovmskb,      "pmovmskb",     0x0000d70f,     0x0000ffff,     X86XMMRegModRM64)
inspick( pmulhuw,       "pmulhuw",      0x0000e40f,     0x0000ffff,     X86XMMRegModRM64_B)
inspick( pmsadbw,       "psadbw",       0x0000f60f,     0x0000ffff,     X86XMMRegModRM64_B)
