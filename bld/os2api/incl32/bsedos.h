...
*  ========================================================================
*
* Description:  OS/2 Base DOS include file for 32-bit development.
*
****************************************************************************/
...
APIRET APIENTRY DosQueryCtryInfo(ULONG cb, PCOUNTRYCODE pcc, PCOUNTRYCODE pci, PULONG pcbActual);
