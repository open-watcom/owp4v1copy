...
EXTERN_C const IID      IID_IOperationsUpdateProgress =
    { 0xB5256C5C, 0xF918, 0x49E6, { 0xBB, 0xB7, 0xA3, 0xC2, 0x54, 0xC0, 0x9F, 0xDF } };
...
EXTERN_C const GUID FOLDERID_TreeProperties =
    { 0x5B3749AD, 0xB49F, 0x49C1, { 0x83, 0xEB, 0x15, 0x37, 0x0F, 0xBD, 0x48, 0x82 } };
...
EXTERN_C const GUID FOLDERID_RecordedTV =
    { 0xBD85E001, 0x112E, 0x431E, { 0x98, 0x3B, 0x7B, 0x15, 0xAC, 0x09, 0xFF, 0xF1 } };
