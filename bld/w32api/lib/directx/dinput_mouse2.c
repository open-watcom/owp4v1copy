...
static DIOBJECTDATAFORMAT c_rgodfDIMouse2[] SECTION_TEXT =
{
...
DIDATAFORMAT c_dfDIMouse2 SECTION_RDATA = {sizeof(DIDATAFORMAT),sizeof(DIOBJECTDATAFORMAT),DIDF_RELAXIS,20,sizeof(c_rgodfDIMouse2)/sizeof(c_rgodfDIMouse2[0]),c_rgodfDIMouse2};
