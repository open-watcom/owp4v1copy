...
static DIOBJECTDATAFORMAT c_rgodfDIMouse[] SECTION_TEXT =
{
...
DIDATAFORMAT c_dfDIMouse SECTION_RDATA = {sizeof(DIDATAFORMAT),sizeof(DIOBJECTDATAFORMAT),DIDF_RELAXIS,16,sizeof(c_rgodfDIMouse)/sizeof(c_rgodfDIMouse[0]),c_rgodfDIMouse};
