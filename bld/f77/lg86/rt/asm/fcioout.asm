...
fcode   RT_OUT_REAL             ; output real*4
        mov     bx,PT_REAL      ; indicate real*4
        hop     Prt             ; output 4 byte value
efcode  RT_OUT_REAL
...
defn    out_lim                 ; report a limit error
        docall  LimError_       ; . . .
        hop     OK              ; ignore unwanted CTRL/Break
endproc out_lim
