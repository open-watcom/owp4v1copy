...
DGROUP  group   _WFDATA_B,_WFDATA,_WFDATA_E,_DATA_INIT_B,_DATA_INIT,_DATA_INIT_E,_CB_DEFN_B,_CB_DEFN,_CB_DEFN_E

;
; this triplet surrounds the global data area
;
_WFDATA_B       segment public para 'BSS'
                public __wfdata_start
__wfdata_start  label byte
_WFDATA_B       ends

_WFDATA         segment public para 'BSS'
_WFDATA         ends

_WFDATA_E       segment public byte 'BSS'
                public __wfdata_end
