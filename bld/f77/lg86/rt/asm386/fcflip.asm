...
dfcode  RX_FLIP
        ...
        lea     esi, 4[esp]     ; shift down the entire xcomplex down 4
        mov     edi, esp        ; ...
        movsd                   ; ...
        movsd                   ; ...
        movsd                   ; ...
...
dfcode  XR_FLIP
        ...
        mov     ebx, esi        ; save the fcode pointer
        lea     esi, 28[esp]    ; shift up the entire xcomplex down 4
        lea     edi, 32[esp]    ; ...
...
dfcode  CX_FLIP
        ...
        mov     edx,4[esp]      ; ...
        mov     ebx, esi        ; save the fcode pointer
        lea     esi,8[esp]      ; shift down the entire xcomplex down 4
        mov     edi, esp        ; ...
        movsd                   ; ...
        movsd                   ; ...
        movsd                   ; ...
...
dfcode  EX_FLIP
        ...
        lea     esi,20[esp]     ; shift down the entire xcomplex down 4
        lea     edi,4[esp]      ; ...
        movsd                   ; ...
        movsd                   ; ...
        movsd                   ; ...
...
dfcode  XE_FLIP
        ...
        lea     esi, 32[esp]    ; shift up the entire xcomplex down 4
        lea     edi, 44[esp]    ; ...
        std                     ; decrement registers, instead of increment
        movsd                   ; ...
        movsd                   ; ...
