...
static  void    (* const __FAR CnvToTab[])() = {                                  //from/
                                                                                  //   /
