...
ifdef _OS2_
        ...
        _if     e                       ; if already done then no needto do so again
          ...
          cmp   ax,es:__STACKLOW        ; and pick the lesser of the two
          _if   b                       ; ...
            mov es:__STACKLOW, ax       ; ...
          _endif                        ; ...
...
ifdef _WINDOWS_
        ...
        mov     ES:SaveSS,SS            ; ...
        mov     AX,ES:__STACKLOW        ; point to new stack
        add     AX,ES:CoStack           ; ...
        add     AX,1                    ; ...
        and     AX,0FFFEh               ; ...
        mov     SS,BX                   ; ...
...
if _MODEL and _BIG_DATA
        ...
        mov     ES,DI                   ; ...
        mov     ES:_IORslt,AX           ; put SCB in IORslt
if _MODEL and _BIG_DATA
        mov     ES:_IORslt+2,DX         ; ...
        mov     ES:_IORslt+4,BX         ; ...
else
        ...
        mov     ES:_IORslt,AX           ; ... data pointer
if _MODEL and _BIG_DATA
        mov     ES:_IORslt+2,DX         ; ...
        mov     ES:_IORslt+4,BX         ; ... number of elements
        mov     ES:_IORslt+6,CX         ; ...
        ...
        mov     SS:6[DI],AX             ; ...
        mov     byte ptr ES:_IORslt+10,DL; ...
else
        mov     ES:_IORslt+2,BX         ; ... number of elements
        mov     ES:_IORslt+4,CX         ; ...
        mov     byte ptr ES:_IORslt+8,DL; ...
endif
        pop     ES                      ; restore ES
        pop     DI                      ; restore DI
if _MODEL and _BIG_DATA
...
if _MODEL and _BIG_DATA
        ...
        mov     ES:_IORslt+2,BX         ; ... number of elements
        mov     ES:_IORslt+4,CX         ; ...
        mov     ES:_IORslt+6,DX         ; ... element size
        mov     AL,PT_CHAR              ; ... type of array
        mov     byte ptr ES:_IORslt+8,AL; ...
endif
        mov     AX,PT_ARRAY             ; return ARRAY type
        pop     ES                      ; restore ES
        pop     DI                      ; restore DI
