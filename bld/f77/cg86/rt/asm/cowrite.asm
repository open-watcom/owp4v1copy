...
if _MATH eq _EMULATION
        ...
        mov     AX,seg DoWrite_         ; indicate write operation
        push    AX                      ; ...
        ...
        cbw                             ; make LOGICAL*4
        cwd                             ; ...
        mov     ES:_IORslt,AX           ; place value in IORslt
        mov     ES:_IORslt+2,DX         ; ...
        ...
        mov     ES,CX                   ; ...
if _MATH eq _8087
        fstp    dword ptr ES:_IORslt    ; place value in IORslt
else
        mov     ES:_IORslt,AX           ; place value in IORslt
        mov     ES:_IORslt+2,DX         ; ...
endif
        ...
        mov     ES,SI                   ; ...
if _MATH eq _8087
        fstp    qword ptr ES:_IORslt    ; place value in IORslt
else
        mov     ES:_IORslt,DX           ; place value in IORslt
        mov     ES:_IORslt+2,CX         ; ...
        mov     ES:_IORslt+4,BX         ; ...
        mov     ES:_IORslt+6,AX         ; ...
endif
...
if _MODEL and _BIG_CODE
        ...
        mov     ES,SI                   ; ...
if _MATH eq _8087
        fstp    tbyte ptr ES:_IORslt    ; place value in IORslt
        pop     ES                      ; restore registers
        pop     SI                      ; ...
else
        pop     ES:_IORslt              ; place value in IORslt
        pop     ES:_IORslt+2            ; ...
        pop     ES:_IORslt+4            ; ...
        pop     ES:_IORslt+6            ; ...
        pop     ES:_IORslt+8            ; ...
...
if _MATH eq _8087
        fstp    qword ptr ES:_IORslt    ; place value in IORslt
        fstp    qword ptr ES:_IORslt+8  ; ...
        pop     ES                      ; restore registers
        pop     SI                      ; ...
else
        mov     ES:_IORslt,DX           ; place real part in IORslt
        mov     ES:_IORslt+2,CX         ; ...
        mov     ES:_IORslt+4,BX         ; ...
        mov     ES:_IORslt+6,AX         ; ...
        pop     ES                      ; restore registers
...
if _MODEL and _BIG_CODE
        ...
        mov     CX,DGROUP               ; get segment address of DGROUP
        mov     ES,CX                   ; ...
        pop     ES:_IORslt+8            ; place imaginary part in IORslt
        pop     ES:_IORslt+10           ; ...
        pop     ES:_IORslt+12           ; ...
        pop     ES:_IORslt+14           ; ...
...
if _MATH eq _8087
        fstp    tbyte ptr ES:_IORslt    ; place value in IORslt
        fstp    tbyte ptr ES:_IORslt+16  ; ...
        pop     ES                      ; restore registers
        pop     SI                      ; ...
else
        pop     ES:_IORslt              ; place real part in IORslt
        pop     ES:_IORslt+2            ; ...
        pop     ES:_IORslt+4            ; ...
        pop     ES:_IORslt+6            ; ...
        pop     ES:_IORslt+8            ; ...
