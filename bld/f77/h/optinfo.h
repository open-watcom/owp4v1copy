...
opt( "",           0,                CTG,         NULL,       CL_CTG_COMPILE_AND_LINK ),
opt( "C",          0,                0,           NULL,       CL_COMPILE_ONLY ),
opt( "Y",          0,                0,           NULL,       CL_IGNORE_WFL ),
opt( "P",          0,                0,           NULL,       CL_RUN_PROTECT ),
opt( "FM[=<fn>]",  0,                0,           NULL,       CL_GENERATE_MAP ),
...
#endif
opt( "L=<system>", 0,                0,           NULL,       CL_LINK_FOR_SYSTEM ),
opt( "K=<n>",      0,                0,           NULL,       CL_STACK_SIZE ),
opt( "\"<drctvs>\"", 0,              0,           NULL,       CL_LINKER_DIRECTIVES ),
#endif
//                      File Management Options
opt( "",           0,                CTG,         NULL,       MS_CTG_FILE_MANAGEMENT ),
opt( "LISt",       OPT_LIST,         CMD|SRC,     &BitOption, MS_OPT_LIST ),
opt( "PRint",      OPT_PRINT,        CMD,         &BitOption, MS_OPT_PRINT ),
opt( "TYpe",       OPT_TYPE,         CMD,         &BitOption, MS_OPT_TYPE ),
opt( "DIsk",       DISK_MASK,        CMD|NEG,     &NegOption, MS_OPT_DISK ),
...
opt( "FPI",        CPUOPT_FPI,       CMD|CPU,     &CPUOption, MS_CPUOPT_FPI ),
opt( "FPI87",      CPUOPT_FPI87,     CMD|CPU,     &CPUOption, MS_CPUOPT_FPI87 ),
opt( "FP2",        CPUOPT_FP287,     CMD|CPU,     &CPUOption, MS_CPUOPT_FP287 ),
opt( "FP3",        CPUOPT_FP387,     CMD|CPU,     &CPUOption, MS_CPUOPT_FP387 ),
opt( "FP5",        CPUOPT_FP5,       CMD|CPU,     &CPUOption, MS_CPUOPT_FP5 ),
opt( "FP6",        CPUOPT_FP6,       CMD|CPU,     &CPUOption, MS_CPUOPT_FP6 ),
opt( "FPR",        CPUOPT_FPR,       CMD|CPU,     &CPUOption, MS_CPUOPT_FPR ),
opt( "FPD",        CPUOPT_FPD,       CMD|CPU,     &CPUOption, MS_CPUOPT_FPD ),
#endif
...
opt( "OH",         OZOPT_O_SUPER_OPTIMAL,
                                     CMD|OZ,      &OZOption,  MS_OZOPT_O_SUPER_OPTIMAL ),
opt( "OI",         OZOPT_O_INLINE,   CMD|OZ,      &OZOption,  MS_OZOPT_O_INLINE ),
opt( "OK",         OZOPT_O_FLOW_REG_SAVES,
                                     CMD|OZ,      &OZOption,  MS_OZOPT_O_FLOW_REG_SAVES ),
opt( "OL",         OZOPT_O_LOOP,     CMD|OZ,      &OZOption,  MS_OZOPT_O_LOOP ),
opt( "OL+",        OZOPT_O_UNROLL,   CMD|OZ,      &OZOption,  MS_OZOPT_O_UNROLL ),
#if COMP_CFG_CG_FPE
opt( "OLF",        OZOPT_O_LOOP_INVAR,
                                     CMD|OZ,      &OZOption,  MS_OZOPT_O_LOOP_INVAR ),
#endif
opt( "OM",         OZOPT_O_MATH,     CMD|OZ,      &OZOption,  MS_OZOPT_O_MATH ),
opt( "ON",         OZOPT_O_NUMERIC,  CMD|OZ,      &OZOption,  MS_OZOPT_O_NUMERIC ),
opt( "OP",         OZOPT_O_VOLATILE, CMD|OZ,      &OZOption,  MS_OZOPT_O_VOLATILE ),
opt( "OR",         OZOPT_O_INSSCHED, CMD|OZ,      &OZOption,  MS_OZOPT_O_INSSCHED ),
opt( "OS",         OZOPT_O_SPACE,    CMD|OZ,      &OZOption,  MS_OZOPT_O_SPACE ),
opt( "OT",         OZOPT_O_TIME,     CMD|OZ,      &OZOption,  MS_OZOPT_O_TIME ),
...
#endif
opt( "3",          CPUOPT_80386,     CMD|CPU,     &CPUOption, MS_CPUOPT_80386 ),
opt( "4",          CPUOPT_80486,     CMD|CPU,     &CPUOption, MS_CPUOPT_80486 ),
opt( "5",          CPUOPT_80586,     CMD|CPU,     &CPUOption, MS_CPUOPT_80586 ),
opt( "6",          CPUOPT_80686,     CMD|CPU,     &CPUOption, MS_CPUOPT_80686 ),
#endif
//                      Application Types
...
opt( "Japanese",   OPT_JAPANESE,     CMD,         &JapOption, MS_OPT_JAPANESE ),
opt( "KOrean",     OPT_KOREAN,       CMD,         &KorOption, MS_OPT_KOREAN ),
//                      Miscellaneous Options
opt( "",           0,                CTG,         NULL,       MS_CTG_MISC ),
opt( "SHort",      OPT_SHORT,        CMD,         &BitOption, MS_OPT_SHORT ),
opt( "XFloat",     OPT_EXTEND_REAL,  CMD,         &BitOption, MS_OPT_EXTEND_REAL ),
opt( "XLine",      OPT_XLINE,        CMD,         &XLOption,  MS_OPT_XLINE ),
opt( "DEFine",     OPT_DEFINE,       CMD|VAL,     &DefOption, MS_OPT_DEFINE ),
opt( "FORmat",     OPT_EXTEND_FORMAT,CMD,         &BitOption, MS_OPT_EXTEND_FORMAT ),
opt( "WILd",       OPT_WILD,         CMD,         &BitOption, MS_OPT_WILD ),
opt( "TErminal",   OPT_TERM,         CMD,         &BitOption, MS_OPT_TERM ),
opt( "Quiet",      OPT_QUIET,        CMD,         &BitOption, MS_OPT_QUIET ),
...
#endif
opt( "SYntax",     OPT_SYNTAX,       CMD,         &BitOption, MS_OPT_SYNTAX ),
opt( "LIBinfo",    OPT_DFLT_LIB,     CMD,         &BitOption, MS_OPT_DFLT_LIB ),
opt( "DT",         CGOPT_DATA_THRESH,CMD|VAL|CG,  &DTOption,  MS_CGOPT_DATA_THRESH ),
