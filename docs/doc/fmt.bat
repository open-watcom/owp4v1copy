...
if ["%1"] == ["FUGUIDE"] set gmlinc=fg;lg;cmn;gml;whelp
if ["%1"] == ["wasaxp"] set gmlinc=cmn;gml;whelp
if ["%1"] == ["WASAXP"] set gmlinc=cmn;gml;whelp
...
if ["%1"] == ["LGUIDE"] set gmlinc=lg;gml;whelp
if ["%1"] == ["lg"] set gmlinc=lg;gml;whelp
if ["%1"] == ["LG"] set gmlinc=lg;gml;whelp
if ["%1"] == ["wlinkerr"] set gmlinc=lg;gml;whelp
if ["%1"] == ["WLINKERR"] set gmlinc=lg;gml;whelp
if ["%1"] == ["rcerrs"] set gmlinc=gui;gml;whelp
if ["%1"] == ["RCERRS"] set gmlinc=gui;gml;whelp
...
if ["%1"] == ["CLIB_DOS"] set gmlinc=lr;lr\src;lr\gr;lr\ge;lr\gp;gml;cmn
if ["%1"] == ["clib_do2"] set gmlinc=lr;lr\src;lr\gr;lr\ge;lr\gp;gml;cmn
if ["%1"] == ["CLIB_DO2"] set gmlinc=lr;lr\src;lr\gr;lr\ge;lr\gp;gml;cmn
if ["%1"] == ["clib_nt"] set gmlinc=lr;lr\src;gml;cmn
if ["%1"] == ["CLIB_NT"] set gmlinc=lr;lr\src;gml;cmn
...
if ["%1"] == ["CLIB_NEC"] set gmlinc=lr;lr\src;lr\gr;lr\ge;lr\gp;gml;cmn
if ["%1"] == ["clib_qnx"] set gmlinc=lr;lr\src;lr\gr;lr\ge;lr\gp;gml;cmn
if ["%1"] == ["CLIB_QNX"] set gmlinc=lr;lr\src;lr\gr;lr\ge;lr\gp;gml;cmn
...
if ["%2"] == ["8x11b"] set gmlopt=nbpsbig
if ["%2"] == ["help"] set gmlopt=nbhlp
if ["%2"] == ["os2help"] set gmlopt=nbhlpos2
if ["%gmlswt%"]==[""] set gmlswt=%2 %3 %4 %5 %6
if ["%2"] == ["wide"] set gmlswt=%3 %4 %5 %6
set gmlout=(t:80)
if ["%1"] == ["pguide"] set gmlout=(t:100)
if ["%1"] == ["PGUIDE"] set gmlout=(t:100)
if ["%1"] == ["fpguide"] set gmlout=(t:100)
if ["%1"] == ["FPGUIDE"] set gmlout=(t:100)
if ["%2"] == ["wide"] set gmlout=(t:900)
if ["%2"] == ["6x8"] set gmlswt=%3 %4 %5 %6
if ["%2"] == ["8x11"] set gmlswt=%3 %4 %5 %6
if ["%2"] == ["8x11b"] set gmlswt=%3 %4 %5 %6
...
Echo Formatting book %1 GMLOPT=%gmlopt% GMLSWT=%gmlswt%
%gml% %1 (file %gmlopt% index pass 1 cpi 10 stat verb output %gmlout% %gmlswt%
if ["%t1%"]==[""] set gml=
if ["%t2%"]==[""] set gmllib=
if ["%t3%"]==[""] set gmlpag=
if ["%t4%"]==[""] set gmlinc=
