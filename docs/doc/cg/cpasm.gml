...
~.386p     .486      .486p     .586      .586p     .686
~.686p     .8087     .287      .387      aaa       aad
aam       aas       adc       add       ah        al
and       arpl      ax        bh        bl        bound
bp        bsf       bsr       bswap     bt        btc       
btr       bts       bx        byte      call      callf     
cbw       cdq       ch        cl        clc       cld       
cli       clts      cmc       cmp       cmps      cmpsb     
cmpsd     cmpsw     cmpxchg   cmpxchg8b cpuid     cr0       
cr2       cr3       cr4       cs        cwd       cwde      
cx        daa       das       db        dd        dec       
df        dh        di        div       dl        dp        
dr0       dr1       dr2       dr3       dr6       dr7       
ds        dup       dw        dword     dx        eax       
ebp       ebx       ecx       edi       edx       enter     
es        esi       esp       f2xm1     fabs      fadd      
faddp     far       fbld      fbstp     fchs      fclex     
...
fisubr    fld       fld1      fldcw     fldenv    fldenvd   
fldenvw   fldl2e    fldl2t    fldlg2    fldln2    fldpi     
fldz      fmul      fmulp     fnclex    fndisi    fneni     
fninit    fnop      fnrstor   fnrstord  fnrstorw  fnsave    
fnsaved   fnsavew   fnstcw    fnstenv   fnstenvd  fnstenvw  
fnstsw    fpatan    fprem     fprem1    fptan     frndint   
frstor    frstord   frstorw   fs        fsave     fsaved    
fsavew    fscale    fsetpm    fsin      fsincos   fsqrt     
fst       fstcw     fstenv    fstenvd   fstenvw   fstp      
fstsw     fsub      fsubp     fsubr     fsubrp    ftst      
fucom     fucomp    fucompp   fwait     fword     fxam      
fxch      fxtract   fyl2x     fyl2xp1   gs        hlt       
idiv      imul      in        inc       ins       insb      
insd      insw      int       into      invd      invlpg    
.millust break
iret      iretd     ja        jae       jb        jbe       
jc        jcxz      je        jecxz     jg        jge       
jl        jle       jmp       jmpf      jna       jnae      
...
ltr       mov       movs      movsb     movsd     movsw     
movsx     movzx     mul       near      neg       .no87      
nop       not       offset    or        out       outs      
outsb     outsd     outsw     pop       popa      popad     
popf      popfd     ptr       push      pusha     pushad    
pushf     pushfd    pword     qword     rcl       rcr       
rdmsr     rdtsc     rep       repe      repne     repnz     
repz      ret       retf      retn      rol       ror       
rsm       sahf      sal       sar       sbb       scas      
scasb     scasd     scasw     seg       seta      setae     
...
setpe     setpo     sets      setz      sgdt      shl       
shld      short     shr       shrd      si        sidt      
sldt      smsw      sp        ss        st        stc       
std       sti       stos      stosb     stosd     stosw     
