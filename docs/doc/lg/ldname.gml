...
Under QNX, no file extension is appended.
...
If you are running a QNX-hosted version of the linker, an executable
...
If you are running a QNX-hosted version of the linker, no file
