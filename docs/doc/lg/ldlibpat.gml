...
&currdir directory first.
If "newsin.&obj" is not in the &currdir directory, the "&pc.math"
directory will be searched.
If any unresolved references remain after processing the object files,
the library file "trig.lib" will be searched.
If the file "trig.lib" does not exist in the &currdir directory, the
...
process the library file "trig.lib" in the &currdir directory.
If "trig.lib" does not exist in the &currdir directory, the
