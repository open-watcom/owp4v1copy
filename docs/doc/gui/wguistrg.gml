...
.figure *depth='3.20' *scale=100 *file='STR1' The String Editor window
.*
.beglevel
.*
...
.*
:CMT. This is a new screen snap shot
.figure *depth='1.67' *scale=180 *file='STR2' The String Editor menu bar
.np
...
.figure *depth='0.88' *scale=100 *file='STR3' You can access seven String Editor functions from the toolbar.
.np
...
.figure *depth='3.20' *scale=100 *file='STR4' The String Editor window contains a menu bar, toolbar, workspace, and status line.
.*
.beglevel
.*
...
.figure *depth='1.46' *scale=100 *file='STR5' As a safety feature, a message box appears when you choose the Clear function.
.*
.endlevel
.*
...
.figure *depth='2.24' *scale=100 *file='STR6' On the Save Menu dialog, specify the resource file to which you want to save the string table.
.begnote
.note Important:
...
.figure *depth='2.24' *scale=100 *file='STR7' On the Copy To dialog, specify the resource file to which you want to copy the String list.
.*
.endlevel
.*
...
:CMT. This is a new screen snap shot
.figure *depth='1.89' *scale=100 *file='STR8' Changing memory options
