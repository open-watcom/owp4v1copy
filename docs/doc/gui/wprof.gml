...
.*
.figure *depth='3.4' *scale=100 *file='WPROF01' The Main Profiler Screen
.np
...
.*
.figure *depth='1.7' *scale=100 *file='WPROF02' The Profiler Title Area
.np
...
.*
.figure *depth='1.9' *scale=100 *file='WPROF03' The Profiler Information Area
.np
...
.*
.figure *depth='3.4' *scale=100 *file='WPROF04' The Profiler Detail View
.np
...
detail area.
.*
.figure *depth='3.4' *scale=100 *file='WPROF05' The Profiler Assembly Detail
.np
...
.*
.figure *depth='2.9' *scale=100 *file='WPROF06' The Profiler Options Dialog
.np
...
.endnote
.figure *depth='3.4' *scale=100 *file='WPROF07' The Bar Graph After the Stretch Option is Selected
.*
.section *refid=prfdcnv The Convert Dialog
.*
.figure *depth='1.85' *scale=100 *file='WPROF08' The Convert Dialog
.np
