...
.keep 15
.figure *depth=2.28 *scale=125 *file='HW1' The Heap Walker window displays lists of memory objects
.*
...
behavior.
.keep 17
.figure *depth='2.67' *scale=125 *file='HW2' On the Heap Walker Configuration dialog, you customize the Heap Walker's behavior
.np
...
allocated.
.keep 15
.figure *depth='2.29' *scale=125 *file='HW3' Choosing the Entire Heap item displays the global heap.
.np
...
about each selector.
.keep 15
.figure *depth='2.29' *scale=125 *file='HW4' The Selector List displays all valid ring three selectors.
.np
...
.*
.keep 8
.figure *depth='1.06' *scale=125 *file='HW5' The Memory Display window displays the data stored in the selected object.
.np
.ix 'Heap Walker' 'Memory Display window'
.ix 'Memory Display window'
...
.keep 15
.figure *depth='2.26' *scale=200 *file='HW6' In the Goto Offset dialog, enter the offset you want to appear at the top of the Memory Display window.
...
.endbull
.keep 11
.figure *depth='1.62' *scale=200 *file='HW7' The Handle Information dialog box displays information for the selected object.
.np
...
.endbull
.keep 13
.figure *depth='1.98' *scale=200 *file='HW8' The Selector Information dialog displays the Selector List information for the selected object.
.np
.ix 'Auto Position Info'
.ix 'Heap Walker' 'Auto Position Info'
...
.keep 13
.figure *depth='1.92' *scale=200 *file='HW9' As you select objects, the Add function calculates and displays the number of selected objects and their total size.
.np
...
the selected object.
.keep 15
.figure *depth='2.25' *scale=125 *file='HW10' The Local Heap Monitor window displays a scale indicating how the selected object is used.
...
.keep 11
.figure *depth='1.59' *scale=125 *file='HW11' The Local Heap window displays the local heap for the selected object.
.np
...
.keep 19
.figure *depth='3.06' *scale=200 *file='HW12' The Local Heap Information dialog displays summary information for the current local heap.
.np
...
heap usage.
.keep 15
.figure *depth='2.30' *scale=200 *file='HW13' The Global Heap Information dialog provides a summary of global heap usage.
.np
...
.keep 17
.figure *depth='2.69' *scale=125 *file='HW14' The Memory Management Information dialog displays information regarding the state of the virtual memory manager.
.np
...
.keep 11
.figure *depth='1.52' *scale=200 *file='HW15' The Allocation Information dialog provides approximate size information regarding allocated and free memory.
.np
...
.endbull
.keep 16
.figure *depth='2.44' *scale=200 *file='HW16' On the allocation dialog box, enter the desired amount of memory to allocate, free, or leave unallocated.
