...
.keep 19
.figure *depth='2.90' *scale=150 *file='DDE1' The &company &dde window contains the event list, menu bar, and toolbar.
.*
...
.endpoint
.figure *depth='0.72' *scale=150 *file='DDE1' The &company &dde menu bar.
.*
...
.endnote
.figure *depth='0.72' *scale=150 *file='DDE1' The &company &dde toolbar.
.*
.endlevel
.*
...
.keep 19
.figure *depth='2.90' *scale=150 *file='DDE2' Once you start spying, the event list displays the information selected for monitoring.
.np
...
.keep 16
.figure *depth='2.45' *scale=150 *file='DDE5' In the Set Message Filter dialog, select the messages on which you want &dde to report.
.np
...
.keep 19
.figure *depth='2.93' *scale=140 *file='DDE6' In the Set Callback Filter dialog, select the transaction types on which you want &dde to report.
.np
...
.keep 15
.figure *depth='2.29' *scale=175 *file='DDE9' The Strings window tracks all strings currently registered with the operating system.
.np
...
.keep 12
.figure *depth='1.70' *scale=175 *file='DDE10' The Conversations window tracks all conversations currently active in the system.
.np
The information in this window is:
.begpoint $break
.point Client
...
.keep 9
.figure *depth='1.21' *scale=125 *file='DDE11' The Links window tracks all links currently active in the system.
.np
The information in this window is:
.begpoint $break
.point Client
...
.keep 12
.figure *depth='1.70' *scale=175 *file='DDE12' The Servers window tracks all servers currently registered with the operating system.
.np
...
has encountered.
.keep 28
.figure *depth='3.45' *scale=150 *file='DDE13' In the Add Alias dialog box, you replace the selected window handle, task, or conversation id with descriptive text.
