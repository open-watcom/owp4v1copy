...
information.
.keep 20
.figure *depth='3.15' *scale=175 *file='SPY10' In the Log Configuration dialog you set the desired behaviour for &appname when logging to a file.
.*
.beglevel
.*
...
.endpoint
.keep 14
.figure *depth='2.14' *scale=200 *file='SPY11' The Log Information message box appears when logging if the Query option is selected on the Log Configuration dialog.
.*
.endlevel
.*
