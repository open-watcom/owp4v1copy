...
.figure *depth='4.64' *scale=200 *file='WZM1' The Zoom window displays, in magnification, the selected screen area.
.*
...
configure dialog.
.figure *depth='2.90' *scale=200 *file='WZM2' On the Configure dialog, you customize the behaviour of the Zoom application.
.*
.beglevel
.*
