...
:FRONTM.
:TITLEP.
:TITLE stitle="Watcom C/C++ Add-In Tools Guide".Watcom C/C++ Add-In Tools Guide
...
.*
.np
Welcome to the Watcom C/C++ &ver..&rev Add-In Tools Guide.  This guide
contains information from a wide variety of third-party vendors
with tools that support and enhance the Watcom C/C++ &ver..&rev
...
the platforms supported by Watcom C/C++.
.np
Note that this may not be a complete list.  Other vendors may
currently be developing support for Watcom C/C++ &ver..&rev..
