Open Watcom C/C++ Version 1.0 - README
--------------------------------------

Welcome to the Open Watcom C/C++ version 1.0 release! This README provides
helpful hints to help you get the software package up and running. For
more detailed information on installation and setup, please refer to
online Getting Started Guide (c_readme.hlp or c_readme.inf).
...
===========================================================
Environment variables used by Open Watcom C/C++
===========================================================
